...
refactor that is itself the topic is fine, as is the file move placement requires of a
PR's new file (two files sharing a prefix become a directory in the same PR).
